...
- **Files touched:**
  - docs/adr/0131-crisis-template-bundle-and-activation-refinements.md
  - docs/implementation-plan.md
  - docs/project docs/Business-Requirements/BRD-0131-Crisis-Template-Bundle-And-Activation-Refinements.md
  - docs/project docs/Functional-Design/FDD-0131-Crisis-Template-Bundle-And-Activation-Refinements.md
  - docs/user-stories/epic-17-adr-0129-to-0133.md
  - social-listening-core/.claude/skills/crisis-baseline-escalation/SKILL.md
  - social-listening-core/contracts/epic-17/story-17.3.crisis-baseline-escalation.contract.test.ts
