...
- ~~**Status:** Pending review~~
**Resolved 2026-08-25:** see docs/management/manager-register.md's matching entry (the 2026-08-25 entry reviewing this whole batch, which also documents a real history-rewrite discovery affecting these commit hashes).
