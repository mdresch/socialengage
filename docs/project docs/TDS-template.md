...
> **Canonical Template:** The master template is maintained at [`docs/templates/technical-design-specification-template.md`](../templates/technical-design-specification-template.md).
>
