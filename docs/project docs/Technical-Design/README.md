...
| [`TDS-0144`](TDS-0144-Repository-Segregation-And-API-Gateway-Implementation.md) | Repository Segregation and API Gateway Implementation | ADR-0144 | Story 20.1 / 20.2 | `story-20.1.openapi-spec-generation.contract.test.ts` (Story 20.2's own contract remains pending — not yet built) |

**Documentation Steward correction, 2026-09-24.** The row above previously read "Pending (Story 20.1 / 20.2 contract)" for both stories, stale since Story 20.1 shipped 2026-09-17 (`social-listening-core@fc5a6856`) with a real, present contract test (`social-listening-core/contracts/epic-20/story-20.1.openapi-spec-generation.contract.test.ts`, confirmed directly in the working tree) — see `docs/user-stories/epic-20-adr-0144.md`'s own Story 20.1 entry and `docs/implementation-log.md`. Corrected in place; Story 20.2 (APIM gateway stand-up) genuinely has no contract yet and stays marked pending.
