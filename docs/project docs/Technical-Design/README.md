...
| [`TDS-0144`](TDS-0144-Repository-Segregation-And-API-Gateway-Implementation.md) | Repository Segregation and API Gateway Implementation | ADR-0144 | Story 20.1 / 20.2 | `story-20.1.openapi-spec-generation.contract.test.ts` (Story 20.2 gateway contract still pending) |
