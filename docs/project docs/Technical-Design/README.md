...
| [`TDS-0144`](TDS-0144-Repository-Segregation-And-API-Gateway-Implementation.md) | Repository Segregation and API Gateway Implementation | ADR-0144 | Story 20.1 / 20.2 | Pending (Story 20.1 / 20.2 contract) |
