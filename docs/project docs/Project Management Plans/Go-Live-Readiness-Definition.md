...
- **Public self-service onboarding** — anyone signing themselves up without individual admission (the not-yet-built self-service tenant sign-up flow, Stories 5.15/5.16/6.7), and
