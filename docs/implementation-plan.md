...
Every story appears exactly once. As of 2026-07-29, all 23 are Ready (1.3 and 5.5 moved up after ADR-0017/0019 were accepted ahead of schedule; 3.5 after ADR-0018's acceptance; 2.4/2.5/3.6/4.4 after ADR-0020–0023's acceptance) — none stay Blocked anywhere. Phase 4's five stories remain scheduled there on their own merits (multi-connector/multi-instance/volume triggers), not because any ADR is still pending.
