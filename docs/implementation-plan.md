...
| 1 | 2.1, 2.2, 2.3, 3.1, 3.2, 3.3, 3.4, 4.3, 2.7, 1.5, 1.6 | — |
| 2 | 4.1, 4.2 | — |
| 3 | 5.1, 5.2, 5.5 | — |
| 4 | 2.4 (may never trigger — see Phase 4's solo-project note), 2.5, 3.5, 3.6, 4.4, 2.6 | — |
| 4.5 | 5.6, 5.7, 5.8, 5.9, 5.10, 1.7 — **all Ready, ADR-0029–ADR-0034 all Accepted 2026-08-03** | — |
| 5 | — | — |
