...
**Source:** ADR-0020 · **Status:** Blocked — pending ADR-0020 acceptance
...
**Source:** ADR-0023 · **Status:** Blocked — pending ADR-0023 acceptance
*(Supersedes the flat threshold in Story 2.3 / ADR-0009-0010 if accepted — see this epic's README note.)*
