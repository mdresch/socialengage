...
- **Publishing / scheduled posting is explicitly out of scope.** Do not wire real social network write APIs, webhooks, or ad placement under the cover of "just a small follow-up." That is ADR-0072's named deferred scope and requires its own ADR.

## Known gaps / deferred work

- Direct automated scheduled posting and social network write APIs are explicitly out of scope per ADR-0072.
