...
- **A real connector-specific reply implementation exists for Facebook only** (`facebookConnector.reply()`, Story 2.27/ADR-0073) — Instagram and LinkedIn are deferred to their own stories.
